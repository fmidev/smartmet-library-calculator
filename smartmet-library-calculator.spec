...
BuildRequires: smartmet-library-newbase-devel >= 22.7.10
BuildRequires: smartmet-library-macgyver-devel >= 22.6.16
BuildRequires: smartmet-library-gis-devel >= 22.7.10
BuildRequires: freetype-devel
%if %{with tests}
BuildRequires: smartmet-library-regression
%endif
Requires: smartmet-library-newbase >= 22.7.10
#TestRequires: make
#TestRequires: gcc-c++
#TestRequires: smartmet-library-regression
#TestRequires: smartmet-library-macgyver-devel
#TestRequires: smartmet-library-newbase-devel >= 22.7.10
#TestRequires: smartmet-library-gis-devel >= 22.7.10
